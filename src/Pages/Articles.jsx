          ...
          <table className="table-auto w-full border-collapse">
            <thead>
              <tr className="bg-soft-primary text-dark-secondary">
                ...
                <th className="px-8">Task Assigned</th>
                <th className="px-8">Deadline</th>
                <th className="px-36">Past Tasks</th>
              </tr>
            </thead>
            <tbody className="pt-10 text-semibold">
              {articles.map((eachArticle) => (
                <tr
                  key={eachArticle._id}
                  className="border-b-3 border-bg-primary"
                >
                  <td className="px-8 py-4">{eachArticle.sNo}</td>
                  <td className="px-8 py-4">
                    <img
                      src={eachArticle.imageUrl}
                      alt="Client"
                      className="sm:w-10 sm:h-10 md:w-15 md:h-15 lg:w-20 lg:h-10 rounded-full object-cover border border-gray-300"
                    />
                  </td>
