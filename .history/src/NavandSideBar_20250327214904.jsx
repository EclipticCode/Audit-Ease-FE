  ...
  return (
    <div className='m-8'>
        ...
        <div className='flex flex-col mt-6 text-light-secondary'>
            <div className='mb-6'><span><i className="fa-solid fa-house mr-4 text-lg"></i></span><span className='font-semibold text-md'>Dashboard</span></div>
            ...
            <div className='mb-6'><span><i className="fa-solid fa-gear mr-6 text-lg"></i></span><span>Settings</span></div>
