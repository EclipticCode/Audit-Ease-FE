  ...
  return (
    ...
    <div>
      <div className='flex flex-col col-start-1 col-end-3 text-light-secondary mt-6'>
          ...
          <div className='mb-6'><span><i className="fa-solid fa-address-book mr-5.5 text-lg"></i></span><span className='font-semibold text-sm'><Link to={}>Contacts</Link></span></div>
