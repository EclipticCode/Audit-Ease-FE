  ...
  return (
    <div className='m-8'>
        ...
        <div className='flex flex-col mt-6'>
            <div className='mb-6'><span><i className="fa-solid fa-house mr-4 text-lg"></i></span classNamefont-semi>Dashboard</div>
            <div className='mb-6'><span><i className="fa-solid fa-calculator mr-6 text-lg"></i></span>Audits</div>
