  ...
  return (
    <div className='m-8'>
        <div className='flex flex-row justify-between'>
            ...
            <div className="bg-gray-200 flex items-center justify-center rounded-full text-xs p-4 w-auto h-4 text-soft-primary"><i className="bi bi-gear"></i></div>
            <div className="bg-gray-200 flex items-center justify-center rounded-full text-xs p-4 w-auto h-4 text-soft-primary"><i className="bi bi-bell"></i></div>
