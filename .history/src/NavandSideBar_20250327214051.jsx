  ...
  return (
    <div className='m-8'>
        ...
        <div className='flex flex-col mt-6'>
            ...
            <div className='mb-6'><span><i className="fa-solid fa-address-book mr-6"></i></span>Contacts</div>
            <div className='mb-6'><span><i className="fa-solid fa-gear mr-6"></i></span>Setting</div>
            <div className='mb-6'><span><i className="bi bi-box-arrow-right mr-4"></i></span>Logout</div>
        </div>
    </div>
  )
}
