...
const NavandSideBar = () => {
  return (
    <div className='m-8'>
        ...
        <div className='flex flex-col mt-6 text-soft-secondary'>
            <div className='mb-6'><span><i className="fa-solid fa-house mr-4 text-lg"></i></span><span className='font-semibold'>Dashboard</span></div>
