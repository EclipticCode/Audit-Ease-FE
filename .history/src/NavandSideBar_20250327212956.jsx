  ...
  return (
    <div className='m-8'>
        ...
        <div className='flex flex-col mt-6'>
            ...
            <div className='mb-6'><span><i className="fa-solid fa-calculator mr-4"></i></span>Clients</div>
            <div className='mb-6'><span><i className="fa-solid fa-house mr-4"></i></span>Audits</div>
            <div className='mb-6'><span><i className="fa-solid fa-house mr-4"></i></span>Articles</div>
            <div className='mb-6'><span><i className="fa-solid fa-house mr-4"></i></span>Contacts</div>
            <div className='mb-6'><span><i className="fa-solid fa-house mr-4"></i></span>Setting</div>
            <div className='mb-6'><span><i className="fa-solid fa-house mr-4"></i></span>Logout</div>
        </div>
    </div>
  )
}
