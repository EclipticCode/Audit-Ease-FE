  ...
  return (
    <div className='m-8'>
        <div className='flex flex-row justify-between'>
            ...
            <div className="bg-gray-200 flex items-center justify-center rounded-full text-lg p-4 w-8 h-4 text-soft-primary text-light-se"><i className="bi bi-gear"></i></div>
